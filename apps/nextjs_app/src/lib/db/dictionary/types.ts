import { type WinkPosTag, type WiktionaryPosTag } from '@/lib/part-of-speech';
...
export type RichToken = {
    l: string; // lemma
    p: WinkPosTag; // Wink NLP part of speech used by game and search rules
