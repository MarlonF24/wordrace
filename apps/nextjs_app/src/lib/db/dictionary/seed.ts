...
const EXPECTED_DICTIONARY_ROW_COUNT = 1_454_988;
...
async function loadRawData(
    jsonlPath: string | undefined = SETTINGS.seedDataPath,
    minRowsForAbort: number = EXPECTED_DICTIONARY_ROW_COUNT
) {
